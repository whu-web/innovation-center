...
import { responsiveGutter22211, responsiveGutter33211 } from '../utils/responsive';
...
const NewsPictorial = React.lazy(() => import('./newsPictorial'));
...
const NewsList: FunctionComponent<NewsListProps> = (props) => { // eslint-disable-line @typescript-eslint/no-unused-vars
