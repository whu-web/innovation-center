...
const responsiveGutter = { xl: 40, lg: 32, md: 24, sm: 24, xs: 15 };
...
const NewsList: FunctionComponent<NewsListProps> = (props) => {
    ...
    return (
        <div className='news-list'>
            ...
            {/* 更多新闻 */}
            <Row className='news-list--section news-list--section-more' gutter={responsiveGutter}>{
                moreNews.map((elem) => (
                    <Col xl={12} lg={24} md={24} sm={24} xs={24} key={elem.id} className='news-list--card-col'>
